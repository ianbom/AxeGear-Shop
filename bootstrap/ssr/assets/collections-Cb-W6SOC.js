...
import { ChevronLeft, ChevronRight, Eye, Layers, MoreVertical, Pencil, Plus, RotateCcw, Search, Sparkles, Star, Trash2 } from "lucide-react";
//#region resources/js/pages/admin/collections/index.tsx
var statusConfig = {
	active: {
		label: "Active",
		dot: "bg-emerald-400",
...
function CollectionsIndex({ collections, filters, stats: totals }) {
	const [search, setSearch] = useState(filters.search ?? "");
	const applyFilter = (key, value) => router.get("/admin/collections", {
		...filters,
		[key]: value,
		page: 1
	}, {
	...
	const resetFilters = () => router.get("/admin/collections", {}, { preserveState: false });
	...
	return /* @__PURE__ */ jsxs(Fragment$1, { children: [/* @__PURE__ */ jsx(Head, { title: "Collections" }), /* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [
					...
					/* @__PURE__ */ jsx("p", {
						...
						children: "Manage your campaign collections like Ramadan, Hajj Series, etc."
					})
				] }), /* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsx(Link, {
						...
						children: /* @__PURE__ */ jsxs(Button, {
							...
							children: [/* @__PURE__ */ jsx(Plus, { className: "h-3.5 w-3.5" }), " Add Collection"]
						})
					})
				})]
			}),
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs("table", {
							...
							children: [/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", {
								...
								children: [collections.data.length === 0 && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", {
									colSpan: 7,
									children: /* @__PURE__ */ jsxs("div", {
										...
										children: [
											/* @__PURE__ */ jsx("div", {
												...
												children: /* @__PURE__ */ jsx(Layers, { className: "h-5 w-5 text-zinc-400" })
											}),
											/* @__PURE__ */ jsx("p", {
												className: "text-sm text-zinc-400",
												children: "No collections found. Try adjusting your filters."
											}),
											/* @__PURE__ */ jsxs(Button, {
												size: "sm",
												variant: "outline",
									...
									return /* @__PURE__ */ jsxs("tr", {
										...
										children: [
											/* @__PURE__ */ jsx("td", {
												...
												children: (collections.from ?? 1) + index
											}),
											/* @__PURE__ */ jsx("td", {
												...
												children: /* @__PURE__ */ jsxs("div", {
													...
													children: [/* @__PURE__ */ jsx("div", {
														...
														children: c.banner_desktop_url ? /* @__PURE__ */ jsx("img", {
															src: c.banner_desktop_url,
															alt: c.name,
															className: "h-full w-full object-cover"
														}) : /* @__PURE__ */ jsx("div", {
															className: "flex h-full w-full items-center justify-center",
															children: /* @__PURE__ */ jsx(Layers, { className: "h-4 w-4 text-zinc-300" })
														})
													}), /* @__PURE__ */ jsxs("div", {
											...
											/* @__PURE__ */ jsx("td", {
												className: "px-4 py-3.5",
												children: c.is_featured ? /* @__PURE__ */ jsx(Badge, {
													variant: "outline",
											...
											/* @__PURE__ */ jsx("td", {
												...
												children: /* @__PURE__ */ jsxs(DropdownMenu, { children: [/* @__PURE__ */ jsx(DropdownMenuTrigger, {
													...
													children: [/* @__PURE__ */ jsx(DropdownMenuItem, {
														...
														onClick: () => {
															if (confirm("Delete " + c.name + "?")) doAction("/admin/collections/" + c.id, "delete");
														},
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", {
							...
							children: collections.from && collections.to ? "Showing " + collections.from + "-" + collections.to + " of " + collections.total + " collections" : "No collections"
						}), /* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-1",
							children: [collections.links.map((link, i) => {
							...
							}), /* @__PURE__ */ jsx(PerPageSelect, { paginator: collections })]
						})]
					})
				]
			})
...
//#endregion
export { CollectionsIndex as default };

//# sourceMappingURL=collections-Cb-W6SOC.js.map